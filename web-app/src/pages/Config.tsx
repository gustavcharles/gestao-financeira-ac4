                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                        ...
                        <button
                            ...
                            className="bg-primary-600 text-white px-4 py-2 rounded-xl font-medium hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 w-full sm:w-auto"
                        >
                            <Plus size={20} />
                            Adicionar
                        </button>
